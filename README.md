...
Для того, чтообы просмотреть список имеющихся веток необходимо команду добавить 

### создание новой ветки

Необходимо использовать программу git branch название новой ветки

## Слияние веток 

Для слияния веток используется команда git merge применяется следующим образом git merge название ветки. В процессе слияния может произойти конфликт или слияние может произойти автоматически
